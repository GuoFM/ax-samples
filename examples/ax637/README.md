...
### YOLO11-OBB
```
root@ax637:~/11obb# ./ax_yolo11_obb -m yolo11l-obb_640x640_npu1.axmodel -i boats.jpg -g 640,640
--------------------------------------
model file : yolo11l-obb_640x640_npu1.axmodel
...
Engine push input is done.
--------------------------------------
post process cost time:62.51 ms
--------------------------------------
Repeat 1 times, avg time 35.48 ms, max_time 35.48 ms, min_time 35.48 ms
--------------------------------------
detection num: 176
 1:  86%, [1121,  535,  117,   36,  +23.0 deg], ship
 1:  86%, [1389,  565,  108,   34,  +18.9 deg], ship
 1:  86%, [1105,  571,  121,   38,  +23.0 deg], ship
 1:  86%, [1819,  547,   99,   32,  +28.9 deg], ship
...
 7:  27%, [1166,  243,  217,  685,  +22.2 deg], harbor
--------------------------------------
```
![YOLO11-OBB](../../docs/ax637/yolo11_obb_out.jpg)
